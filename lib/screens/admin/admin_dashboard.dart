      ...
      body: ResponsiveContainer(
        child: ListView(
          ...
          children: [
            ...
            _AdminCard(
              title: 'إدارة المواقع',
              subtitle: 'إضافة وتعديل مواقع البحث',
            ...
            _AdminCard(
              ...
              subtitle: 'إضافة وتعديل باقات الحج والعمرة',
              icon: Icons.mosque_outlined,
              onTap: () => context.push('/admin/hajj-umrah/packages'),
            ),
            const SizedBox(height: 12),
            _AdminCard(
              title: 'حملات الحج والعمرة',
              subtitle: 'إدارة الحملات الموسمية والسعات',
              icon: Icons.flag_outlined,
              onTap: () => context.push('/admin/hajj-umrah/campaigns'),
            ),
            const SizedBox(height: 12),
            _AdminCard(
              title: 'مجموعات الحج والعمرة',
              subtitle: 'توزيع الحجاج على مجموعات ومشرفين',
              icon: Icons.group_outlined,
              onTap: () => context.push('/admin/hajj-umrah/groups'),
            ),
            const SizedBox(height: 12),
            _AdminCard(
              title: 'طلبات الحج والعمرة',
              subtitle: 'متابعة الطلبات وتحديث الحالات',
              icon: Icons.assignment_outlined,
              onTap: () => context.push('/admin/hajj-umrah/applications'),
            ),
            const SizedBox(height: 12),
            _AdminCard(
              title: 'التقارير',
